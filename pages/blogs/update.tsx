...
const Update = () => {
  ...
  const { data, isLoading: initLoad } = useGetBlogsById(id as string);
...
//     url: `${process.env.NEXT_PUBLIC_BASE_URL}/api/blogs/${context.query?.id}/id`,
//     method: "get",
//   });
